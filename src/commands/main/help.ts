...
import { CommandInteraction as Interaction, MessageActionRow, MessageEmbed, MessageSelectMenu } from 'discord.js';
...
module.exports = {
	...
	async execute(interaction: Interaction) {
		const helpEmbed = new MessageEmbed()
			...
			.setFooter({ text: '(͡ ͡° ͜ つ ͡͡°)7 | schnose.eu/church', iconURL: process.env.ICON });
		...
		answer(interaction, { embeds: [helpEmbed], components: [commandMenu], ephemeral: true });
	},
};
